...
<!--顶部信息-->
<div class="top-style">
    <!--<img class="img-portrait" src="<?php echo $picture; ?>">-->
    <img class="img-portrait" src="<?php echo base_url('image/default-avatar.png'); ?>">
...
<div class="reserve-message">
    ...
    <a href = "<?php echo site_url('User/editWeight'); ?>"><img class="btn-in2" src="<?php echo base_url('image/in.png'); ?>"></a>
...
<div class="reserve-message">
    ...
    <a href = "<?php echo site_url('User/editHeight'); ?>"><img class="btn-in2" src="<?php echo base_url('image/in.png'); ?>"></a>
...
<div class="reserve-message" style="border-top: none">
    ...
    <a href = "<?php echo site_url('User/editPosition'); ?>"><img class="btn-in2" src="<?php echo base_url('image/in.png'); ?>"></a>
